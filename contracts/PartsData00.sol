...
contract PartsData00 {
    ...
    constructor(address _address) {
        ...
        // Gen(_address).addPartsData('00', 'env', maParts['00']['env']);
        Gen(_address).addPartsData('00', 'clo', maParts['00']['clo']);
        Gen(_address).addPartsData('00', 'head', maParts['00']['head']);
        Gen(_address).addPartsData('00', 'mouth', maParts['00']['mouth']);
        Gen(_address).addPartsData('00', 'eyes', maParts['00']['eyes']);
        Gen(_address).addPartsData('00', 'top', maParts['00']['top']);
